...
const Profile = () => {
  ...
  const validate = (values) => {
    ...
    if (!oldPassword) {
      ...
      errors.oldPassword =
        "Old password cannot exceed more than 30 characters!";
    }
    if (!newPassword) {
      ...
      errors.newPassword =
        "New password cannot exceed more than 30 characters!";
    }
    if (!password) {
      ...
      errors.password =
        "Confirmed password cannot exceed more than 30 characters!";
